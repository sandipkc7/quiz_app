-- ============================================================
-- Production Migration Script (Safe & Idempotent)
-- File: /temp/production_migration.sql
--
-- Instructions:
--   You can run this script directly in phpMyAdmin, MySQL CLI,
--   or run `php migrate.php` from project root.
--   Once applied on production, this entire `/temp` folder
